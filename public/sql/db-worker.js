...
var SQLModule = function (moduleConfig) {
  if (initSqlJsPromise) {
  ...
  initSqlJsPromise = new Promise(function (resolveModule, reject) {
    ...
    e.onRuntimeInitialized = function () {
          ...
          for (g = []; 0 !== l(G, "i8"); ) {
            ...
            if (0 !== I) {
              ...
              for (null != m && v.bind(m); v.step(); )
                null === y &&
                  ((y = { columns: v.getColumnNames(), values: [] }),
                  g.push(y)),
      ...
      f.prototype.create_function = function (g, m) {
        Object.prototype.hasOwnProperty.call(this.Na, g) &&
          (ra(this.Na[g]), delete this.Na[g]);
      ...
      f.prototype.create_aggregate = function (g, m) {
        ...
        var y = {};
        Object.hasOwnProperty.call(this.Na, g) &&
          (ra(this.Na[g]), delete this.Na[g]);
        m = g + "__finalize";
        Object.hasOwnProperty.call(this.Na, m) &&
          (ra(this.Na[m]), delete this.Na[m]);
      ...
      Q = {
        ...
        createNode: function (a, b, c, d) {
          ...
          16384 === (c.mode & 61440)
            ...
            : 32768 === (c.mode & 61440)
            ? ((c.Ga = Q.Qa.file.node),
              (c.Ha = Q.Qa.file.stream),
              (c.Ma = 0),
              (c.Ia = null))
            : 40960 === (c.mode & 61440)
            ? ((c.Ga = Q.Qa.link.node), (c.Ha = Q.Qa.link.stream))
            : 8192 === (c.mode & 61440) &&
              ((c.Ga = Q.Qa.pb.node), (c.Ha = Q.Qa.pb.stream));
        ...
        try {
          return (
            ...
            0 === c
              ...
              : 512 === c
              ? Tb(b)
              : E("Invalid flags passed to unlinkat"),
            0
          );
        } catch (d) {
          if ("undefined" == typeof W || !(d instanceof P)) throw d;
    ...
    (function () {
      ...
      if (e.instantiateWasm)
        try {
          ...
          return (
            Ha("Module.instantiateWasm callback failed with error: " + f), !1
          );
        }
      (function () {
        return Ia ||
    ...
    e._sqlite3_bind_parameter_index = function () {
      return (e._sqlite3_bind_parameter_index = e.asm.qa).apply(
        null,
        arguments
      );
    };
    ...
    var zb = (e._emscripten_builtin_memalign = function () {
        return (zb = e._emscripten_builtin_memalign = e.asm.Ca).apply(
          null,
          arguments
        );
      }),
      ...
      function a() {
        if (!Xc && ((Xc = !0), (e.calledRun = !0), !Ka)) {
          e.noFSInit ||
            ...
            e.stdout
              ? cc("stdout", null, e.stdout)
              : Sb("/dev/tty", "/dev/stdout"),
            e.stderr
              ? cc("stderr", null, e.stderr)
              : Sb("/dev/tty1", "/dev/stderr"),
            ja("/dev/stdin", 0),
            ja("/dev/stdout", 1),
            ja("/dev/stderr", 1));
          Db = !1;
...
Comlink.expose({
  pleaseDo(data) {
    return ModuleInstance.then(onModuleReady.bind(data)).catch(
      onError.bind(data)
    );
  },
});
